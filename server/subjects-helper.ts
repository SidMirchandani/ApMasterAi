...
const SUBJECT_REGISTRY: Record<string, SubjectMeta> = {
  ...
  'APPHYS1': {
    ...
    units: [
      { id: 'KIN', title: 'Kinematics', description: 'Motion in one and two dimensions', examWeight: '12-18%' },
      { id: 'DYN', title: 'Dynamics', description: "Newton's laws and force analysis", examWeight: '16-20%' },
      { id: 'CMG', title: 'Circular Motion and Gravitation', description: 'Uniform circular motion and gravitational forces', examWeight: '6-8%' },
      { id: 'ENR', title: 'Energy', description: 'Work, energy, and conservation laws', examWeight: '20-28%' },
      { id: 'MOM', title: 'Momentum', description: 'Impulse, momentum, and collisions', examWeight: '12-18%' },
      { id: 'SHM', title: 'Simple Harmonic Motion', description: 'Springs, pendulums, and oscillations', examWeight: '4-6%' },
      { id: 'TRM', title: 'Torque and Rotational Motion', description: 'Rotational kinematics and dynamics', examWeight: '12-18%' }
    ],
    sectionKeywords: {
      KIN: ["velocity", "acceleration", "displacement", "projectile", "kinematics", "motion", "free fall", "trajectory"],
      DYN: ["newton", "force", "friction", "normal force", "tension", "net force", "free body diagram", "mass"],
      CMG: ["circular motion", "centripetal", "gravitational", "orbit", "satellite", "period", "gravity"],
      ENR: ["kinetic energy", "potential energy", "work", "power", "conservation of energy", "spring", "joule"],
      MOM: ["momentum", "impulse", "collision", "elastic", "inelastic", "conservation of momentum"],
      SHM: ["oscillation", "pendulum", "spring", "period", "frequency", "amplitude", "harmonic"],
      TRM: ["torque", "angular velocity", "angular acceleration", "moment of inertia", "rotational", "angular momentum"],
    },
  },
  'APPHYS2': {
    subjectCode: 'APPHYS2',
    ...
    units: [
      { id: 'FLU', title: 'Fluids', description: 'Fluid statics, dynamics, and pressure', examWeight: '10-12%' },
      { id: 'THD', title: 'Thermodynamics', description: 'Heat, temperature, and thermodynamic laws', examWeight: '12-18%' },
      { id: 'EFP', title: 'Electric Force, Field, and Potential', description: 'Coulomb law, electric fields, and potential', examWeight: '18-22%' },
      { id: 'EC', title: 'Electric Circuits', description: 'Current, resistance, and circuit analysis', examWeight: '14-20%' },
      { id: 'MEI', title: 'Magnetism and Electromagnetic Induction', description: 'Magnetic forces and electromagnetic induction', examWeight: '10-12%' },
      { id: 'GPO', title: 'Geometric and Physical Optics', description: 'Reflection, refraction, and interference', examWeight: '12-14%' },
      { id: 'QAN', title: 'Quantum, Atomic, and Nuclear Physics', description: 'Photoelectric effect, atomic models, nuclear physics', examWeight: '10-12%' }
    ],
    sectionKeywords: {
      ...
      MEI: ["magnetic field", "magnet", "electromagnetic", "induction", "faraday", "lenz", "flux"],
      GPO: ["reflection", "refraction", "lens", "mirror", "diffraction", "interference", "snell", "wave", "optics"],
      QAN: ["quantum", "photon", "photoelectric", "atomic", "nuclear", "radioactive", "half-life", "bohr"],
    },
  },
  'APES': {
    subjectCode: 'APES',
