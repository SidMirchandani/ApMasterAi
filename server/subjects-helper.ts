...
const SUBJECT_REGISTRY: Record<string, SubjectMeta> = {
    ...
    units: [
      {
        ...
        description: "Scarcity, opportunity cost, production possibilities",
        examWeight: "5-10%",
      },
      {
        id: "EIBC",
        title: "Economic Indicators & Business Cycle",
        description: "GDP, unemployment, inflation",
        examWeight: "12-17%",
      },
      {
        id: "NIPD",
      ...
      },
      {
        ...
        description: "Fiscal policy and government spending",
        examWeight: "20-30%",
      },
      {
        id: "OEITF",
        title: "Open Economy—International Trade and Finance",
        description: "Balance of payments, exchange rates",
        examWeight: "10-13%",
      },
    ],
    sectionKeywords: {
  ...
  APMICRO: {
    ...
    units: [
      ...
      },
      {
        ...
        description: "Externalities, public goods, and income inequality",
        examWeight: "8-13%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Collaboration, program design, and development",
        examWeight: "10-13%",
      },
      {
        id: "DAT",
        title: "Data",
        description: "Binary numbers, data compression, and extraction",
        examWeight: "17-22%",
      },
      {
        id: "AAP",
        title: "Algorithms and Programming",
        description: "Variables, algorithms, and programming techniques",
        examWeight: "30-35%",
      },
      {
        id: "CSN",
        title: "Computer Systems and Networks",
        description: "Internet, routing, and network protocols",
        examWeight: "11-15%",
      },
      {
        id: "IOC",
        title: "Impact of Computing",
        description: "Ethics, privacy, security, and societal impacts",
        examWeight: "21-26%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Moles, mass spectrometry, electron configuration",
        examWeight: "7-9%",
      },
      {
        id: "MIS",
        title: "Molecular & Ionic Structure",
        description: "Lewis structures, VSEPR, bonding",
        examWeight: "7-9%",
      },
      {
        id: "IMF",
        title: "Intermolecular Forces & Properties",
        description: "Phase changes, solutions, mixtures",
        examWeight: "18-22%",
      },
      {
        id: "RXN",
        title: "Chemical Reactions",
        description: "Reaction types, stoichiometry",
        examWeight: "7-9%",
      },
      {
        id: "KIN",
        title: "Kinetics",
        description: "Rate laws, reaction mechanisms",
        examWeight: "7-9%",
      },
      {
        id: "THERMO",
        title: "Thermodynamics",
        description: "Energy, enthalpy, entropy, free energy",
        examWeight: "7-9%",
      },
      {
        id: "EQM",
        title: "Equilibrium",
        description: "Le Chatelier, equilibrium constants",
        examWeight: "7-9%",
      },
      {
        id: "ACB",
        title: "Acids & Bases",
        description: "pH, titrations, buffers",
        examWeight: "11-15%",
      },
      {
        id: "ATD",
        title: "Applications of Thermodynamics",
        description: "Electrochemistry, Gibbs free energy",
        examWeight: "7-9%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Constitutional principles and federalism",
        examWeight: "15-22%",
      },
      {
        id: "IAB",
        title: "Interactions Among Branches of Government",
        description: "Separation of powers and checks and balances",
        examWeight: "25-36%",
      },
      {
        id: "CLCR",
        title: "Civil Liberties and Civil Rights",
        description: "Bill of Rights and Equal Protection Clause",
        examWeight: "13-18%",
      },
      {
        id: "APIB",
        title: "American Political Ideologies and Beliefs",
        description: "Political socialization and ideology",
        examWeight: "10-15%",
      },
      {
        id: "PP",
        title: "Political Participation",
        description: "Voting, campaigns, and elections",
        examWeight: "20-27%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Brain anatomy, neurotransmitters, nervous system, and genetics",
        examWeight: "15-25%",
      },
      {
        id: "COG",
        title: "Cognition",
        description: "Memory, thinking, problem-solving, and language",
        examWeight: "15-25%",
      },
      {
        id: "DEV",
        title: "Development and Learning",
        description: "Lifespan development, learning theories, and cognitive development",
        examWeight: "15-25%",
      },
      {
        id: "SOC",
        title: "Social Psychology and Personality",
        description: "Social influence, attitudes, personality theories, and assessment",
        examWeight: "15-25%",
      },
      {
        id: "MPH",
        title: "Mental and Physical Health",
        description: "Psychological disorders, treatment approaches, and health psychology",
        examWeight: "15-25%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Water, carbon compounds, and macromolecules",
        examWeight: "8-11%",
      },
      {
        id: "CSF",
        title: "Cell Structure and Function",
        description: "Cell theory, organelles, and membranes",
        examWeight: "10-13%",
      },
      {
        id: "CE",
      ...
      },
      {
        ...
        description: "Signal transduction and mitosis",
        examWeight: "10-15%",
      },
      {
        id: "HER",
        title: "Heredity",
        description: "Meiosis, Mendelian genetics, and DNA",
        examWeight: "8-11%",
      },
      {
        id: "GER",
      ...
      },
      {
        ...
        description: "Evolution, population genetics, and speciation",
        examWeight: "13-20%",
      },
      {
        id: "ECO",
        title: "Ecology",
        description: "Energy flow, biodiversity, and ecosystems",
        examWeight: "10-15%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Finding limits, continuity, and asymptotic behavior",
        examWeight: "10-12%",
      },
      {
        id: "DDF",
        title: "Differentiation: Definition and Fundamental Properties",
        description: "Derivative definition and basic rules",
        examWeight: "10-12%",
      },
      {
        id: "DCI",
        title: "Differentiation: Composite, Implicit, and Inverse Functions",
        description: "Chain rule, implicit differentiation",
        examWeight: "9-13%",
      },
      {
        id: "CAD",
      ...
      },
      {
        ...
        description: "Mean value theorem and curve analysis",
        examWeight: "15-18%",
      },
      {
        id: "IAC",
      ...
      },
      {
        ...
        description: "Slope fields and separable equations",
        examWeight: "6-12%",
      },
      {
        id: "AI",
        title: "Applications of Integration",
        description: "Area, volume, and motion problems",
        examWeight: "10-15%",
      },
    ],
    sectionKeywords: {
  ...
  APCALCBC: {
    ...
    units: [
      ...
      },
      {
        id: "IAC",
        title: "Integration and Accumulation of Change",
        description: "Definite integrals and techniques",
        examWeight: "17-20%",
      },
      {
        id: "DE",
        title: "Differential Equations",
        description: "Slope fields, Euler method, logistic models",
        examWeight: "6-9%",
      },
      {
        id: "AI",
        title: "Applications of Integration",
        description: "Area, volume, and arc length",
        examWeight: "6-9%",
      },
      {
        id: "PPV",
    ...
    units: [
      {
        ...
        description: "Primitive types, Math class, String methods, wrapper classes",
        examWeight: "15–25%",
      },
      {
        id: "U2",
        title: "Selection and Iteration",
        description: "Conditionals, loops, boolean expressions, De Morgan's Laws",
        examWeight: "25–35%",
      },
      {
        id: "U3",
        title: "Class Creation",
        description: "Classes, constructors, encapsulation, inheritance, polymorphism",
        examWeight: "10–18%",
      },
      {
        id: "U4",
        title: "Data Collections",
        description: "Arrays, ArrayList, 2D arrays, recursion, searching and sorting",
        examWeight: "30–40%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Pre-Columbian societies and early exploration",
        examWeight: "4-6%",
      },
      {
        id: "P2",
        title: "Period 2: 1607-1754",
        description: "Colonial America and European colonization",
        examWeight: "6-8%",
      },
      {
        id: "P3",
        title: "Period 3: 1754-1800",
        description: "American Revolution and early republic",
        examWeight: "10-17%",
      },
      {
        id: "P4",
        title: "Period 4: 1800-1848",
        description: "Democracy, expansion, and reform movements",
        examWeight: "10-17%",
      },
      {
        id: "P5",
        title: "Period 5: 1844-1877",
        description: "Civil War and Reconstruction",
        examWeight: "10-17%",
      },
      {
        id: "P6",
        title: "Period 6: 1865-1898",
        description: "Industrialization and the Gilded Age",
        examWeight: "10-17%",
      },
      {
        id: "P7",
        title: "Period 7: 1890-1945",
        description: "Progressive Era, World Wars, and the New Deal",
        examWeight: "10-17%",
      },
      {
        id: "P8",
        title: "Period 8: 1945-1980",
        description: "Cold War, civil rights, and social change",
        examWeight: "10-17%",
      },
      {
        id: "P9",
        title: "Period 9: 1980-Present",
        description: "Modern America and globalization",
        examWeight: "4-6%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Diverse states and civilizations across regions",
        examWeight: "8-10%",
      },
      {
        id: "NE",
        title: "Networks of Exchange (1200-1450)",
        description: "Trade routes, cultural diffusion, and technology transfer",
        examWeight: "8-10%",
      },
      {
        id: "LBE",
        title: "Land-Based Empires (1450-1750)",
        description: "Ottoman, Safavid, Mughal, and other empires",
        examWeight: "12-15%",
      },
      {
        id: "TI",
        title: "Transoceanic Interconnections (1450-1750)",
        description: "European exploration and global trade networks",
        examWeight: "12-15%",
      },
      {
        id: "REV",
      ...
      },
      {
        ...
        description: "Economic, social, and environmental effects",
        examWeight: "12-15%",
      },
      {
        id: "GC",
        title: "Global Conflict (1900-Present)",
        description: "World wars and ideological struggles",
        examWeight: "8-10%",
      },
      {
        id: "CWD",
        title: "Cold War and Decolonization (1900-Present)",
        description: "Bipolar world order and independence movements",
        examWeight: "8-10%",
      },
      {
        id: "GLO",
        title: "Globalization (1900-Present)",
        description: "Global integration and contemporary challenges",
        examWeight: "8-10%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Renaissance culture and overseas exploration",
        examWeight: "10-15%",
      },
      {
        id: "AR",
        title: "Age of Reformation",
        description: "Protestant and Catholic Reformations",
        examWeight: "10-15%",
      },
      {
        id: "AC",
        title: "Absolutism and Constitutionalism",
        description: "State building and political authority",
        examWeight: "10-15%",
      },
      {
        id: "SPP",
        title: "Scientific, Philosophical, Political Developments",
        description: "Scientific Revolution and Enlightenment",
        examWeight: "10-15%",
      },
      {
        id: "CRR",
        title: "Conflict, Revolution, and Reaction",
        description: "French Revolution and Napoleonic era",
        examWeight: "10-15%",
      },
      {
        id: "IND",
      ...
      },
      {
        ...
        description: "Nationalism, liberalism, and conservatism",
        examWeight: "10-15%",
      },
      {
        id: "GCF",
        title: "20th Century Global Conflicts",
        description: "World Wars and totalitarianism",
        examWeight: "10-15%",
      },
      {
        id: "CCE",
        title: "Cold War and Contemporary Europe",
        description: "Post-war Europe and European integration",
        examWeight: "10-15%",
      },
    ],
    sectionKeywords: {
  ...
  APLANG: {
    ...
    units: [
      {
        id: "CRE",
        title: "Claims, Reasoning, and Evidence",
        description: "Building and evaluating arguments",
        examWeight: "20-25%",
      },
      {
        id: "SS",
        title: "Synthesizing Sources",
        description: "Integrating multiple sources into arguments",
        examWeight: "20-25%",
      },
      {
        id: "RS",
        title: "Rhetorical Situation",
        description: "Purpose, audience, context, and rhetorical strategies",
        examWeight: "20-25%",
      },
      {
        id: "OC",
        title: "Organization and Commentary",
        description: "Essay structure and analytical commentary",
        examWeight: "15-20%",
      },
      {
        id: "ARG",
        title: "Argumentation",
        description: "Constructing persuasive arguments",
        examWeight: "15-20%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Character, setting, and narrative perspective",
        examWeight: "10-13%",
      },
      {
        id: "PO1",
        title: "Poetry I",
        description: "Structure, figurative language, and imagery",
        examWeight: "10-13%",
      },
      {
        id: "LF1",
        title: "Longer Fiction or Drama I",
        description: "Plot, character development, and conflict",
        examWeight: "10-13%",
      },
      {
        id: "SF2",
        title: "Short Fiction II",
        description: "Comparisons, contexts, and interpretations",
        examWeight: "10-13%",
      },
      {
        id: "PO2",
        title: "Poetry II",
        description: "Comparison and contrast in poetry",
        examWeight: "10-13%",
      },
      {
        id: "LF2",
        title: "Longer Fiction or Drama II",
        description: "Thematic complexity and literary techniques",
        examWeight: "10-13%",
      },
      {
        id: "SF3",
      ...
      },
      {
        id: "PO3",
        title: "Poetry III",
        description: "Advanced poetic analysis",
        examWeight: "6-8%",
      },
      {
        id: "LF3",
    ...
    units: [
      {
        ...
        description: "Distributions, measures of center and spread",
        examWeight: "15-23%",
      },
      {
        id: "ETV",
        title: "Exploring Two-Variable Data",
        description: "Scatterplots, correlation, and regression",
        examWeight: "5-7%",
      },
      {
        id: "CD",
        title: "Collecting Data",
        description: "Sampling methods and experimental design",
        examWeight: "12-15%",
      },
      {
        id: "PRD",
        title: "Probability, Random Variables, and Distributions",
        description: "Probability rules and distribution models",
        examWeight: "10-20%",
      },
      {
        id: "SD",
        title: "Sampling Distributions",
        description: "Central limit theorem and sampling variability",
        examWeight: "7-12%",
      },
      {
        id: "ICP",
        title: "Inference for Categorical Data: Proportions",
        description: "Confidence intervals and tests for proportions",
        examWeight: "12-15%",
      },
      {
        id: "IQM",
      ...
      },
      {
        ...
        description: "Chi-square tests for association",
        examWeight: "2-5%",
      },
      {
        id: "IQS",
        title: "Inference for Quantitative Data: Slopes",
        description: "Inference for regression slopes",
        examWeight: "2-5%",
      },
    ],
    sectionKeywords: {
  ...
  APPHYS1: {
    ...
    units: [
      ...
      },
      {
        ...
        description: "Newton's laws, force analysis, and translational motion",
        examWeight: "18-23%",
      },
      {
        id: "WEP",
      ...
      },
      {
        ...
        description: "Impulse, linear momentum, and collisions",
        examWeight: "10-15%",
      },
      {
        id: "TRD",
        title: "Unit 5: Torque and Rotational Dynamics",
        description: "Torque, rotational kinematics, and rotational dynamics",
        examWeight: "10-15%",
      },
      {
        id: "EMR",
        title: "Unit 6: Energy and Momentum of Rotating Systems",
        description: "Rotational kinetic energy and angular momentum",
        examWeight: "5-8%",
      },
      {
        id: "OSC",
        title: "Unit 7: Oscillations",
        description: "Simple harmonic motion, springs, and pendulums",
        examWeight: "5-8%",
      },
      {
        id: "FLU",
        title: "Unit 8: Fluids",
        description: "Fluid statics, dynamics, pressure, and buoyancy",
        examWeight: "10-15%",
      },
    ],
    sectionKeywords: {
  ...
  APPHYS2: {
    ...
    units: [
      ...
      },
      {
        ...
        description: "Coulomb law, electric fields, and potential",
        examWeight: "15-18%",
      },
      {
        id: "EC",
      ...
      },
      {
        ...
        description: "Magnetic forces and electromagnetic induction",
        examWeight: "12-15%",
      },
      {
        id: "GPO",
        title: "Unit 13: Geometric Optics",
        description: "Reflection, refraction, and mirror analysis",
        examWeight: "12-15%",
      },
      {
        id: "WPO",
        title: "Unit 14: Waves, Sound, and Physical Optics",
        description: "Interference, diffraction, and wave properties",
        examWeight: "12-15%",
      },
      {
        id: "MOD",
    ...
    units: [
      {
        ...
        description: "Energy flow, nutrient cycling, and ecosystem services",
        examWeight: "6-8%",
      },
      {
        id: "LWB",
        title: "The Living World: Biodiversity",
        description: "Species diversity, ecosystem resilience",
        examWeight: "6-8%",
      },
      {
        id: "POP",
        title: "Populations",
        description: "Population ecology and human population dynamics",
        examWeight: "10-15%",
      },
      {
        id: "ESR",
        title: "Earth Systems and Resources",
        description: "Plate tectonics, soil, atmosphere, and water",
        examWeight: "10-15%",
      },
      {
        id: "LWU",
        title: "Land and Water Use",
        description: "Agriculture, forestry, mining, and water management",
        examWeight: "10-15%",
      },
      {
        id: "ERC",
        title: "Energy Resources and Consumption",
        description: "Renewable and nonrenewable energy sources",
        examWeight: "10-15%",
      },
      {
        id: "APL",
        title: "Atmospheric Pollution",
        description: "Air pollution, smog, and acid deposition",
        examWeight: "7-10%",
      },
      {
        id: "ATP",
        title: "Aquatic and Terrestrial Pollution",
        description: "Water pollution, soil contamination, and waste",
        examWeight: "7-10%",
      },
      {
        id: "GCH",
        title: "Global Change",
        description: "Climate change, ozone depletion, and biodiversity loss",
        examWeight: "15-20%",
      },
    ],
    sectionKeywords: {
    ...
    units: [
      {
        ...
        description: "Geographic concepts, tools, and spatial thinking",
        examWeight: "8-10%",
      },
      {
        id: "PMP",
        title: "Population and Migration",
        description: "Population distribution, growth, and migration patterns",
        examWeight: "12-17%",
      },
      {
        id: "CPP",
        title: "Cultural Patterns and Processes",
        description: "Cultural landscapes, diffusion, and identity",
        examWeight: "12-17%",
      },
      {
        id: "PPP",
        title: "Political Patterns and Processes",
        description: "Political organization, boundaries, and governance",
        examWeight: "12-17%",
      },
      {
        id: "ARL",
        title: "Agriculture and Rural Land-Use",
        description: "Agricultural practices and food systems",
        examWeight: "12-17%",
      },
      {
        id: "CUL",
        title: "Cities and Urban Land-Use",
        description: "Urbanization, urban models, and sustainability",
        examWeight: "12-17%",
      },
      {
        id: "IED",
        title: "Industrial and Economic Development",
        description: "Industrialization, development, and globalization",
        examWeight: "12-17%",
      },
    ],
    sectionKeywords: {
