...
const SUBJECT_REGISTRY: Record<string, SubjectMeta> = {
  ...
  'APCHEM': {
    ...
    units: [
      { id: 'ASP', title: 'Atomic Structure & Properties', description: 'Moles, mass spectrometry, electron configuration', examWeight: '7-9%' },
      { id: 'MIS', title: 'Molecular & Ionic Structure', description: 'Lewis structures, VSEPR, bonding', examWeight: '7-9%' },
      { id: 'IMF', title: 'Intermolecular Forces & Properties', description: 'Phase changes, solutions, mixtures', examWeight: '18-22%' },
      { id: 'RXN', title: 'Chemical Reactions', description: 'Reaction types, stoichiometry', examWeight: '7-9%' },
      { id: 'KIN', title: 'Kinetics', description: 'Rate laws, reaction mechanisms', examWeight: '7-9%' },
      { id: 'THERMO', title: 'Thermodynamics', description: 'Energy, enthalpy, entropy, free energy', examWeight: '7-9%' },
      { id: 'EQM', title: 'Equilibrium', description: 'Le Chatelier, equilibrium constants', examWeight: '7-9%' },
      { id: 'ACB', title: 'Acids & Bases', description: 'pH, titrations, buffers', examWeight: '11-15%' },
      { id: 'ATD', title: 'Applications of Thermodynamics', description: 'Electrochemistry, Gibbs free energy', examWeight: '7-9%' }
    ],
    sectionKeywords: {
      ASP: ["atom", "mole", "mass spectrometry", "electron configuration", "periodic trends", "ionization energy", "atomic structure"],
      MIS: ["ionic bonding", "covalent bonding", "lewis structure", "vsepr", "hybridization", "molecular geometry"],
      IMF: ["london dispersion", "dipole", "hydrogen bonding", "phase changes", "solutions", "colligative properties", "intermolecular"],
      RXN: ["stoichiometry", "limiting reagent", "oxidation", "reduction", "precipitation", "chemical reaction", "acid-base"],
      KIN: ["reaction rate", "rate law", "activation energy", "catalysis", "mechanisms", "collision theory", "kinetics"],
      THERMO: ["enthalpy", "entropy", "gibbs free energy", "calorimetry", "hess's law", "spontaneity", "thermodynamics"],
      EQM: ["equilibrium constant", "le chatelier", "reaction quotient", "ice table", "kp", "kc", "equilibrium"],
      ACB: ["ph", "poh", "buffer", "titration", "weak acid", "strong base", "ka", "kb", "acid", "base"],
  ...
  'APPHYS1': {
    ...
    units: [
      ...
      { id: 'FTD', title: 'Unit 2: Force and Translational Dynamics', description: "Newton's laws, force analysis, and translational motion", examWeight: '18-23%' },
      { id: 'WEP', title: 'Unit 3: Work, Energy, and Power', description: 'Work-energy theorem, conservation of energy, and power', examWeight: '18-23%' },
      { id: 'LMO', title: 'Unit 4: Linear Momentum', description: 'Impulse, linear momentum, and collisions', examWeight: '10-15%' },
      { id: 'TRD', title: 'Unit 5: Torque and Rotational Dynamics', description: 'Torque, rotational kinematics, and rotational dynamics', examWeight: '10-15%' },
      { id: 'EMR', title: 'Unit 6: Energy and Momentum of Rotating Systems', description: 'Rotational kinetic energy and angular momentum', examWeight: '5-8%' },
      { id: 'OSC', title: 'Unit 7: Oscillations', description: 'Simple harmonic motion, springs, and pendulums', examWeight: '5-8%' },
      { id: 'FLU', title: 'Unit 8: Fluids', description: 'Fluid statics, dynamics, pressure, and buoyancy', examWeight: '10-15%' }
    ],
    sectionKeywords: {
      KIN: ["velocity", "acceleration", "displacement", "projectile", "kinematics", "motion", "free fall", "trajectory", "position", "speed"],
      FTD: ["newton", "force", "friction", "normal force", "tension", "net force", "free body diagram", "mass", "dynamics", "translational", "gravity", "weight"],
      WEP: ["kinetic energy", "potential energy", "work", "power", "conservation of energy", "work-energy theorem", "joule", "watt", "gravitational potential"],
      LMO: ["momentum", "impulse", "collision", "elastic", "inelastic", "conservation of momentum", "linear momentum", "center of mass"],
      TRD: ["torque", "angular velocity", "angular acceleration", "moment of inertia", "rotational", "rotational dynamics", "lever arm", "net torque"],
      EMR: ["angular momentum", "rotational kinetic energy", "conservation of angular momentum", "rolling", "rotating system"],
      OSC: ["oscillation", "pendulum", "spring", "period", "frequency", "amplitude", "harmonic", "simple harmonic motion", "restoring force"],
      FLU: ["fluid", "pressure", "buoyancy", "archimedes", "bernoulli", "density", "pascal", "viscosity", "flow rate", "hydraulic"],
    },
  },
  'APPHYS2': {
    subjectCode: 'APPHYS2',
