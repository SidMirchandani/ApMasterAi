...
export const SUBJECT_SECTIONS: SubjectSections = {
  ...
  APWORLD: [
    { code: "GT", name: "The Global Tapestry (1200–1450)" },
    { code: "NE", name: "Networks of Exchange (1200–1450)" },
    { code: "LBE", name: "Land-Based Empires (1450–1750)" },
    { code: "TI", name: "Transoceanic Interconnections (1450–1750)" },
    { code: "REV", name: "Revolutions (1750–1900)" },
    { code: "COI", name: "Consequences of Industrialization (1750–1900)" },
    { code: "GC", name: "Global Conflict (1900–Present)" },
    { code: "CWD", name: "Cold War and Decolonization (1900–Present)" },
    { code: "GLO", name: "Globalization (1900–Present)" },
  ],
  APCSA: [
