    ...
    <div className="min-h-screen bg-background text-foreground dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-gray-50 sm:text-4xl tracking-tight mb-4">
            About APMaster.ai
          </h1>
        ...
        <Card className="border-none shadow-xl bg-white dark:bg-gray-900 overflow-hidden mb-16">
          <CardContent className="p-6 sm:p-8">
            <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-200 leading-relaxed">
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-4 border-l-4 border-[#36b37e] pl-6 italic">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#36b37e]/5 dark:bg-[#36b37e]/10 p-6 rounded-2xl border border-[#36b37e]/10 my-6">
        ...
        <div className="mt-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-50 text-center mb-6">Our Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Siddharth Mirchandani</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Vivana Satiani</h3>
              <p className="text-[#36b37e] font-semibold mb-4">Co-founder</p>
              <div className="flex justify-center gap-4">
