        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-khan-gray-medium max-w-2xl mx-auto">
              Test your knowledge with real AP-style questions and get instant feedback.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border-2 border-gray-100 p-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <h3 className="text-sm font-bold text-khan-gray-dark mb-1">55 Questions</h3>
                <p className="text-xs text-khan-gray-medium">Multiple choice & FRQ</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-sm font-bold text-khan-gray-dark mb-1">3 Hours 15 Min</h3>
                <p className="text-xs text-khan-gray-medium">Real exam timing</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-sm font-bold text-khan-gray-dark mb-1">Detailed Analytics</h3>
                <p className="text-xs text-khan-gray-medium">Performance insights</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-sm font-bold text-khan-gray-dark mb-1">Instant Feedback</h3>
                <p className="text-xs text-khan-gray-medium">Explanations included</p>
              </div>
            </div>
            
            <div className="text-center">
              <h2 className="text-2xl font-bold text-khan-gray-dark mb-4">Practice Test Coming Soon</h2>
              <p className="text-khan-gray-medium mb-6">
                We're creating comprehensive practice tests with real AP-style questions for optimal exam preparation.
                Our diagnostic tests will help identify your strengths and areas for improvement.
              </p>
