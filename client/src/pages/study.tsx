      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            ...
            <div className="mt-8 flex flex-col md:flex-row gap-3 max-w-2xl mx-auto justify-center">
              <Button
                onClick={() =>
                  router.push(`/practice-test/${subjectId}?type=mcq`)
                }
                className="bg-khan-green hover:bg-khan-green/90 w-full md:w-auto md:flex-1 h-12 min-h-[44px]"
              >
              ...
              <Button
                ...
                className="bg-khan-blue hover:bg-khan-blue/90 w-full md:w-auto md:flex-1 h-12 min-h-[44px]"
              >
          ...
          {units.map((unit, index) => (
            <Card key={unit.id} className="border-l-4 border-l-khan-green">
              <CardContent className="pt-6">
                ...
                <div className="flex flex-col md:flex-row gap-3 ml-0 sm:ml-14 max-w-2xl mx-auto justify-center">
                  <Button
                    onClick={() =>
                      router.push(
                    ...
                    variant="outline"
                    className="border-2 border-khan-green text-khan-green hover:bg-khan-green hover:text-white min-h-[44px] w-full md:w-auto md:flex-1"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-2 border-khan-blue text-khan-blue hover:bg-khan-blue hover:text-white w-full md:w-auto md:flex-1 min-h-[44px]"
                  >
