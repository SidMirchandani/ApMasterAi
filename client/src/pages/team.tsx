      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {teamMembers.map((member) => (
            <Card key={member.name} className="border-none shadow-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden group">
              <CardContent className="p-6 text-center">
                <div className="w-28 h-28 bg-[#36b37e]/10 rounded-full mx-auto mb-4 flex items-center justify-center border-4 border-[#36b37e]/20 dark:border-gray-800 transition-all duration-300 group-hover:border-[#36b37e]">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 italic">"{member.bio}"</p>
                <div className="flex justify-center gap-4">
                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-[#36b37e] hover:text-white transition-colors">
                    <Linkedin className="w-5 h-5" />
                  </a>
                  <a href={`mailto:${member.email}`} className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-[#36b37e] hover:text-white transition-colors">
