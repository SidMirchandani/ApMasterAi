    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#36b37e] rounded-2xl mb-6 shadow-lg shadow-green-100 dark:shadow-none">
            <BookOpen className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-gray-50 sm:text-5xl tracking-tight mb-4">
            About APMaster.ai
          </h1>
        ...
        <Card className="border-none shadow-xl bg-white dark:bg-gray-900 overflow-hidden">
          <CardContent className="p-8 sm:p-12">
            <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-200 leading-relaxed">
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-8 border-l-4 border-[#36b37e] pl-6 italic">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#36b37e]/5 dark:bg-[#36b37e]/10 p-8 rounded-2xl border border-[#36b37e]/10 my-10">
                  <p className="text-xl font-bold text-gray-900 dark:text-gray-50 mb-4">Our vision is simple but ambitious:</p>
              ...
              <div className="mt-16 pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <div>
                  <p className="font-bold text-xl text-gray-900 dark:text-gray-50 mb-1">Vivana Satiani and Siddharth Mirchandani</p>
